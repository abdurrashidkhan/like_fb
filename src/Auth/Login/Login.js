      ...
      <div className="">
        <div className="h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-md  w-full  bg-slate-200 p-4 rounded-lg shadow-lg">
            ...
            {/* social login */}
            <button className="border-none gap-3 mx-auto  rounded-md text-white bg-blue-700 hover:bg-blue-600  focus:outline-none focus:none focus:none focus:none text-4xl">
              <SocialLogin className='w-full h-auto'></SocialLogin>
            </button>
            {/* <button className="">
